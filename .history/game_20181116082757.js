...
function checkKing() {
  ...
  console.log(kings.faction)
  if (kings.includes(kings.faction == "black")) {
    console.log("black king dead")
  }
  if (kings.includes(kings.faction == "white")) {
    console.log("white king dead")
  }
  else {
