...
function moveChessman(pos, chessman) {
  chessman.position.logical.col = Math.trunc(pos.x / TILE_SIZE);
  chessman.position.logical.row = Math.trunc(pos.y / TILE_SIZE);
