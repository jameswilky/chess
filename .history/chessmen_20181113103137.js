  ...
  if (dragOk) {
    ...
    chessmen.forEach(chessman => {
      if (chessman.isDragging) {
        //change graphical position
        chessman.position.graphical.x = dpos.x;
        chessman.position.graphical.y = dpos.y;
        chessman.render();
        console.log(dpos.x, dpos.y);
        console.log(chessman.position.graphical, chessman.position.graphical)
