...
function moveChessman(col, row, chessman) {
  console.log(chessman.position.logical.row, chessman.position.logical.col)
  if ((chessman.position.logical.row * TILE_SIZE == row) && (chessman.position.logical.col * TILE_SIZE == col)) {
