  ...
  if (dragOk == false) {
    ...
    for (i = 0; i < chessmen.length; i++) {
      if (coordsMatch(pos, chessmen[i].position.graphical)) {
        ...
        chessmen[i].derender(chessmen_ctx);
        ball.style.position = 'absolute';
        ball.style.zIndex = 1000;
        ball.src = chessmen[i].sprite;

        ball.style.left = e.clientX - TILE_SIZE / 2 + 'px';
        ball.style.top = e.clientY - TILE_SIZE / 2 + 'px';
        ...
        function moveAt(pageX, pageY) {
          ball.style.left = pageX - e.clientX - TILE_SIZE / 2 + 'px';
          ball.style.top = pageY - e.clientX - TILE_SIZE / 2 + 'px';
        }
