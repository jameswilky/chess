...
function render_markers() {
  ...
  function move(col, row) {
    if (moveIsValid(this.position.logical.row, row, this.position.logical.col, col, chessman)) {
      ...
      this.position.graphical.x = chessman.position.logical.col * TILE_SIZE;
      this.position.graphical.y = chessman.position.logical.row * TILE_SIZE;
      this.derender();
      this.render();
